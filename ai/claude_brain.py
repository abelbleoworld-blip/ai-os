...
4. COMMENT ОБЯЗАТЕЛЕН и должен быть полезным: объясни что делаешь и зачем, как друг.
...
- Хороший comment: "Смотрю что происходит с памятью и какие процессы больше всего жрут ресурсов"
- Плохой comment: "" (пустой)
